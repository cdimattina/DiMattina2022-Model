...
Author: Josiah Burnham (9/2021)
Org:    FGCU
Desc:   Prepares a Dataset to preform K-Fold Cross Validation
"""
...
class DatasetMaker:
    ...
    """
    def __init__(self, file_path, num_files, num_img=1000, x_shape=1600, y_shape=2,
                num_folds=10):
        """
